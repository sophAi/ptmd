...
* Last Modified : 2010年04月20日 (週二) 10時06分37秒
...
11      continue
      ...
      function rndi(rndi_range)  
      implicit none
      integer rndi,rndi_range !assign the range from 0 to rani_range
      real*8 rnd
      rndi=1+dint(dble(rndi_range)*rnd())
      end
