...
* Last Modified : 2011年04月13日 (週三) 12時59分04秒
* License : GPL (see bottom)
* Encoding : utf-8
* Project : sophAi
* Description :
* ========================================================================
      subroutine edit_mom_score
      implicit none
...
!Default input file name
      call edit_source
      call edit_target
      write(*,*)"Please prepare your target file in the usr directory"
      write(*,*)"The default target file name should be : ",
     &target_file_name
      sel="99"
      do while(sel.ne."0")
     ...
     &" NOTE! Use consine will decrease the sensitivity"
          ...
          write(*,*) 
     &" 3.Output a specific moment and its ensemble average"
          write(*,*) 
     &"Note for 3, be sure to turn only one moment at a time"
          write(*,*) 
     &"Please refer to option 4: Select only one moment to calculate"
          write(*,*) "-------------------------------------------"
     ...
     & "0. Do not output moments,calculate ensemble average only"
          write(*,*) "1. Write score vs time(*.scr)"
