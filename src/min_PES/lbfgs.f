...
C
      ...
      REAL*8 X(ndim_max),G(ndim_max),DIAG(ndim_max),
     &W(ndim_max*(2*M+1)+2*M)
...
C
      ...
      REAL*8 X(ndim_max),G(ndim_max),F,GNORM,STP,GTOL,STPMIN,STPMAX
      LOGICAL FINISH
      COMMON /LB3/MP,LP,GTOL,STPMIN,STPMAX
C
      IF (ITER.EQ.0)THEN
...
C
      ...
      REAL*8 X(ndim_max),G(ndim_max),S(ndim_max),WA(ndim_max)
      COMMON /LB3/MP,LP,GTOL,STPMIN,STPMAX
      SAVE
C
C                     SUBROUTINE MCSRCH
