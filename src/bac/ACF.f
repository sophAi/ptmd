...
* Last Modified : 2010年04月20日 (週二) 10時01分29秒
...
C      goto 200
C==============================================
      if(VACF_read_file_flag.ne.3)then
        open(19,file=file_name,status="old")
        read(19,*)VACF_total_time_step
        close(19)
      endif
...
C      goto 500  !jump to DFT
     ...
     &VACF_observe_time_step
      ...
      do I1=1,VACF_observe_time_step
        ...
        enddo
C========Only for Velocity ACF===============
C        call centre
C========debug==============
C        call centre_velocity
C=======end================
C        call fix_angular
C        if(VACF_method.eq.2)call histogram
C        pause
C        call cn_init
C        call cn
C        call cn2name
...
C============end=================
        call fix_angular
        if(VACF_method.eq.2)call histogram
        do I5=1,atom_num
          I6=I5*3
...
C=============Writing Energy Gistogram================
      if(VACF_method.eq.2)then
        if(wscreen)write(*,"(I5,1x,A30)")
     &myid,"Start writing energy histogram"
...
C=================================================================
     ...
     &VACF_file_name(:index(VACF_file_name," ")-1)//int2char//"_org.vaf"
      modified_name=VACF_path_name(:index(VACF_path_name," ")-1)//
     &vaf_path(:index(vaf_path," ")-1)//
     &VACF_file_name(:index(VACF_file_name," ")-1)//int2char//"_org_"//
     &time_label_char//".vaf"
      call rename(source_name,modified_name)

      source_name=VACF_path_name(:index(VACF_path_name," ")-1)//
     &vaf_path(:index(vaf_path," ")-1)//
     &VACF_file_name(:index(VACF_file_name," ")-1)//int2char//"_nor.vaf"
      modified_name=VACF_path_name(:index(VACF_path_name," ")-1)//
     &vaf_path(:index(vaf_path," ")-1)//
     &VACF_file_name(:index(VACF_file_name," ")-1)//int2char//"_nor_"//
     &time_label_char//".vaf"
     ...
     &VACF_file_name(:index(VACF_file_name," ")-1)//int2char//
     &"_real.dft"
      modified_name=VACF_path_name(:index(VACF_path_name," ")-1)//
     &dft_path(:index(dft_path," ")-1)//
     &VACF_file_name(:index(VACF_file_name," ")-1)//int2char//"_real_"
     &//time_label_char//".dft"
     ...
     &"_img.dft"
      modified_name=VACF_path_name(:index(VACF_path_name," ")-1)//
     &dft_path(:index(dft_path," ")-1)//
     &VACF_file_name(:index(VACF_file_name," ")-1)//int2char//"_img_"//
     &time_label_char//".dft"
     ...
     &VACF_file_name(:index(VACF_file_name," ")-1)//int2char//".diff"
      modified_name=VACF_path_name(:index(VACF_path_name," ")-1)//
     &diff_path(:index(diff_path," ")-1)//
     &VACF_file_name(:index(VACF_file_name," ")-1)//int2char//"_"//
...
C     &VACF_file_name(:index(VACF_file_name," ")-1)//"_diff.dat"

C      modified_name=VACF_path_name(:index(VACF_path_name," ")-1)//
C     &diff_path(:index(diff_path," ")-1)//
C     &VACF_file_name(:index(VACF_file_name," ")-1)//"_diff_"//
