*========================================================================
* File Name : locate_current_frame.f
* Copyright (C) 2008-2011 Po-Jen Hsu <xanadu8850@pchome.com.tw>
* Creation Date : 19-04-2010
* Last Modified : 2010年10月24日 (週日) 10時37分47秒
     ...
     &(read_life_flag(I0),read_life_num(I0),I0=1,par_num1)
      ...
      if(life_num_temp.eq.life_num)then
        do I0=1,par_num1
          ...
          if(read_life_flag(I0).eq."ensemble_num=")ensemble_num=
     &read_life_num(I0)
...
11    close(20)
      if(.not.locate_life)then
        write(*,*) "Can not locate life! Quit!!" 
        stop
      endif
      return
      end
