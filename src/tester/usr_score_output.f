*========================================================================
* File Name : usr_score_output.f 
* Copyright (C) 2008-2011 Po-Jen Hsu <xanadu8850@pchome.com.tw>
* Creation Date : 19-04-2010
* Last Modified : Sun 25 Mar 2012 11:36:49 AM CST
* License : GPL (see bottom)
* Encoding : utf-8
* Project : sophAi
* Description :
* ========================================================================
      subroutine usr_score_output
      implicit none
     ...
     &(:index(score_mean_file_name," ")-1)//"o"
          if(wscreen) write(*,"(I5,1x,A47,1x,A80)") 
...
C      do I0=target_init,target_final
C        write(21,*) I0,tdusr_temp,tdusr(I0)
C      enddo
      write(22,"(F15.7,100(1x,F15.7))") 
     &score_temp,(score_mean(I0),I0=target_init,target_final)
      close(22)
      return
      end
