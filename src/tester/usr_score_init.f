*========================================================================
* File Name : usr_score_init.f 
* Copyright (C) 2008-2011 Po-Jen Hsu <xanadu8850@pchome.com.tw>
* Creation Date : 19-04-2010
* Last Modified : Thu 21 Apr 2011 11:19:30 AM CST
* License : GPL (see bottom)
* Encoding : utf-8
* Project : sophAi
* Description :
* ========================================================================
      subroutine usr_score_init  !life_num,job_num have been known,then jump to the correspond parameters
      implicit none
     ...
     &"4th=",score_4th_io
      ...
      subroutine usr_score_mom_time_header_file
      implicit none
      include "../../include/global_common.h"
      include "../../include/common.h"
      include "../../include/file.h"
      ...
      character char4*4,char4_id*4,octave_mom_time_header_file*80
      ...
      header_par_name(10)="total_moment_x_num"
      header_par_real(10)=dble(total_moment_x_num)
      header_annotation=
     &"'IDx IDy moment_1~moment_n pot cst_id fct_id ftf_id'"
      ...
      subroutine usr_score_time_header_file
      implicit none
      include "../../include/global_common.h"
      include "../../include/common.h"
      include "../../include/file.h"
     ...
     &(target_final-target_init+1)
        ...
        enddo
        write(23,"(A25)")"# Total number of members"
